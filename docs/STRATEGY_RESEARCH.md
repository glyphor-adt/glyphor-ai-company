...
| Deep Dive Schema | `db/migrations/20260227100012_deep_dive_tables.sql` (applied to Cloud SQL) |
| CoT Schema | `db/migrations/20260227100008_cot_analyses.sql` (applied to Cloud SQL) |
| Strategy Lab v2 | `db/migrations/20260227100027_strategy_lab_v2.sql` (applied to Cloud SQL) |
| World Model Architecture | `db/migrations/20260227100034_world_model_architecture.sql` (applied to Cloud SQL) |
