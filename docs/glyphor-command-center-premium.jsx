...
const DEPARTMENTS = [
  ...
  { id: "finance", name: "Finance", color: "#10b981", agents: [
    { id: "ledger", name: "Ledger", title: "CFO", badge: "★", score: 96, status: "active", activity: "Daily P&L complete", lastActive: "5h ago", connections: ["atlas","forge","mint","vault"] },
    { id: "mint", name: "Mint", title: "Revenue Analyst", score: 93, status: "active", activity: "Cohort LTV analysis", lastActive: "3h ago", connections: ["ledger"] },
    { id: "vault", name: "Vault", title: "Cost Analyst", score: 95, status: "active", activity: "Gemini API cost audit", lastActive: "5h ago", connections: ["ledger","stack"] },
  ]},
  { id: "marketing", name: "Marketing", color: "#ec4899", agents: [
    { id: "beacon", name: "Beacon", title: "CMO", badge: "★", score: 86, status: "active", activity: "Queuing social content", lastActive: "3h ago", connections: ["atlas","compass","pixel","echo"] },
    { id: "pixel", name: "Pixel", title: "Content Creator", score: 84, status: "active", activity: "Drafting case study", lastActive: "3h ago", connections: ["beacon","signal"] },
    ...
    { id: "echo", name: "Echo", title: "Social Media", score: 82, status: "active", activity: "LinkedIn post scheduled", lastActive: "4h ago", connections: ["beacon"] },
  ]},
  { id: "customer", name: "Customer Success", color: "#3b82f6", agents: [
    { id: "harbor", name: "Harbor", title: "VP Customer Success", badge: "★", score: 90, status: "active", activity: "Health scores updated", lastActive: "5h ago", connections: ["atlas","lens","guide","closer"] },
    { id: "guide", name: "Guide", title: "Onboarding", score: 91, status: "active", activity: "Welcome flow analysis", lastActive: "6h ago", connections: ["harbor"] },
    { id: "care", name: "Care", title: "Support", score: 88, status: "active", activity: "Ticket triage complete", lastActive: "4h ago", connections: ["harbor"] },
  ]},
