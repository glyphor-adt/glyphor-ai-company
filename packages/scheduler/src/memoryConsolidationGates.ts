...
export function buildMemoryConsolidationPromptMessage(stats: {
  ...
  return [
    ...
    '3. Use **save_memory** only where it improves durability: merged summaries, corrected facts, or new cross-cutting lessons. Prefer updating via new consolidated memories rather than dozens of tiny duplicates.',
