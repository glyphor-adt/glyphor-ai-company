/**
 * AI Impact Analyst (Riya Mehta) — Runner
 * Reports to Sophia Lin (VP of Research & Intelligence). AI impact research.
 */
import {
...
import { AI_IMPACT_ANALYST_SYSTEM_PROMPT } from './systemPrompt.js';
import { createAIImpactAnalystTools } from './tools.js';
...
export async function runAIImpactAnalyst(params: AIImpactAnalystRunParams = {}) {
  ...
  const config: AgentConfig = {
    id: `riya-${task}-${today}-${Date.now()}`,
    role: 'ai-impact-analyst',
    systemPrompt: AI_IMPACT_ANALYST_SYSTEM_PROMPT,
