...
- Internal engines are INTERNAL capabilities — not standalone products to market, launch, or report on as separate product lines.
- Legacy internal identifiers may still appear in code, repos, env vars, team scopes, and tool names. Treat them as internal labels, not founder questions or external product framing.
