...
export function Card({
  ...
  return (
    <div
      className={`sidebar-glass glass-card-layout rounded-2xl border p-5 ${interactive ? 'transition-all hover:-translate-y-0.5 active:translate-y-0' : ''} ${glow ? 'glass-card--glow' : ''} ${className}`}
...
export function InnerCard({
  ...
  return (
    <div
      className={`sidebar-glass glass-inner-layout rounded-xl border px-4 py-3 ${className}`}
      style={buildCardStyle(accent, style)}
      {...rest}
    >
      <div className="glass-card__content">
