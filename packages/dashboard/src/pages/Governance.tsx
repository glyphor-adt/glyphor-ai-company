    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        <button
          ...
          onClick={() => refresh()}
          disabled={refreshing}
          className="rounded-lg border border-primary/20 bg-black/20 px-4 py-2 text-[13px] font-medium text-txt-secondary transition-colors hover:border-primary/40 hover:text-txt-primary disabled:opacity-50"
        >
