...
const TOOL_CATALOG: Record<string, ToolInfo> = {
  ...
  send_teams_dm: { description: 'Send a direct message in Teams', category: 'm365', platform: 'm365' },
  read_teams_dm: { description: 'Read recent messages from a Teams direct message thread', category: 'm365', platform: 'm365' },
  ...
  request_tool_access: { description: 'Request access to an existing tool', category: 'workflow' },
  ...
  // M365 / Teams
  search_sharepoint: { description: 'Search the company SharePoint knowledge base', category: 'm365', platform: 'm365' },
  read_sharepoint_document: { description: 'Read a SharePoint document', category: 'm365', platform: 'm365' },
  upload_to_sharepoint: { description: 'Upload a document to SharePoint', category: 'm365', platform: 'm365' },
  list_sharepoint_folders: { description: 'List SharePoint knowledge folders', category: 'm365', platform: 'm365' },
  list_sharepoint_files: { description: 'List files in a SharePoint folder', category: 'm365', platform: 'm365' },
  create_sharepoint_page: { description: 'Create a SharePoint page', category: 'm365', platform: 'm365' },
...
function getHumanToolLabel(toolName: string): string {
  const explicitLabels: Record<string, string> = {
    ...
    send_teams_dm: 'Send Teams DM',
    read_teams_dm: 'Read Teams DM',
    ...
    read_sharepoint_document: 'Read SharePoint Document',
    write_sharepoint: 'Write SharePoint',
    manage_sharepoint: 'Manage SharePoint',
    search_sharepoint: 'Search SharePoint',
    list_sharepoint_folders: 'List SharePoint Folders',
    list_sharepoint_files: 'List SharePoint Files',
    upload_to_sharepoint: 'Upload To SharePoint',
    create_sharepoint_page: 'Create SharePoint Page',
    request_tool_access: 'Request Tool Access',
