...
export const AGENT_EMAIL_MAP: Record<CompanyAgentRole, AgentEmailEntry> = {
  ...
  'cto':                  { email: 'marcus@glyphor.ai',    displayName: 'Marcus Webb',       title: 'CTO' },
  'cpo':                  { email: 'elena@glyphor.ai',     displayName: 'Elena Vasquez',     title: 'CPO' },
  'cmo':                  { email: 'james@glyphor.ai',     displayName: 'James Okafor',      title: 'CMO' },
  'cfo':                  { email: 'rachel@glyphor.ai',    displayName: 'Rachel Kim',        title: 'CFO' },
  'vp-customer-success':  { email: 'maya@glyphor.ai',      displayName: 'Maya Johnson',      title: 'VP Customer Success' },
  'vp-sales':             { email: 'derek@glyphor.ai',     displayName: 'Derek Chang',       title: 'VP Sales' },
  'vp-design':            { email: 'claire@glyphor.ai',    displayName: 'Claire Dubois',     title: 'VP Design' },
