...
export const MODEL_RATES: Record<string, { input: number; output: number; thinking?: number }> = {
  ...
  // Gemini — Vertex AI list prices (2026-04-22)
  'gemini-3.1-pro-preview':     { input: 2.50,   output: 15.00,  thinking: 15.00 },
  'gemini-3.1-flash-lite-preview': { input: 0.10, output: 0.40,  thinking: 0.40 },
  'gemini-3-flash-preview':     { input: 1.25,   output: 5.00,   thinking: 5.00 },
  'gemini-3.1-pro':             { input: 2.50,   output: 15.00,  thinking: 15.00 },
  'gemini-3.1-flash-lite':      { input: 0.10,   output: 0.40 },
  'gemini-3-flash':             { input: 1.25,   output: 5.00 },
