...
const STATIC_ROUTES: RouteConfig[] = [
  { route_name: 'economy',              model_slug: 'gemini-2.5-flash-lite',          priority: 100 },
  { route_name: 'workhorse',            model_slug: 'gemini-3.1-flash-lite-preview',  priority: 50 },
  { route_name: 'orchestration',        model_slug: 'gemini-2.5-pro',                 priority: 90 },
  { route_name: 'executive_assignment', model_slug: 'gemini-3-flash-preview',         priority: 80 },
  { route_name: 'complex_research',     model_slug: 'gemini-2.5-pro',                 priority: 85 },
  { route_name: 'financial_complex',    model_slug: 'gemini-2.5-pro',                 priority: 85 },
  { route_name: 'visual_analysis',      model_slug: 'gemini-2.5-pro',                 priority: 85 },
  { route_name: 'code_gen',             model_slug: 'gemini-3.1-flash-lite-preview',  priority: 70 },
  { route_name: 'founder_chat',         model_slug: 'gemini-3-flash-preview',         priority: 75 },
  { route_name: 'triangulation',        model_slug: 'gpt-5.4',                        priority: 95 },
  { route_name: 'default',              model_slug: 'gemini-3.1-flash-lite-preview',  priority: 0 },
];
