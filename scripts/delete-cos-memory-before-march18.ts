/**
 * Wipe all chief-of-staff agent_memory rows before 2026-03-18 UTC.
 * Run: npx tsx scripts/run-with-gcp-db-secret.ts --db-user glyphor_app --db-password-secret db-password scripts/delete-cos-memory-before-march18.ts
 */
