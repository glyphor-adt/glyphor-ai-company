...
const directiveRows = [
  ...
  { title: 'Pulse Pricing Model', priority: 'high', category: 'finance', target_agents: ['cfo'], status: 'active', due_date: plus10d,
  ...
  { title: 'AI Model Cost Analysis', priority: 'high', category: 'finance', target_agents: ['cfo','cost-analyst'], status: 'active', due_date: plus5d,
