...
\echo '=== 5. SARAH ORCHESTRATION SUCCESS ==='
SELECT
  ar.status,
  ar.task,
  ar.turns,
...
-- 6a. WORK ASSIGNMENT STATUS SUMMARY
\echo '=== 6a. WORK ASSIGNMENT STATUS SUMMARY ==='
SELECT
  wa.status,
  COUNT(*) AS count,
...
\echo '=== 8. PROACTIVE WORK FREQUENCY ==='
SELECT
  ar.agent_id,
